 ...
 */
public class MousseFragment extends Fragment implements IRadioFragment {

    private ImageView bgView;
    private String imageNameString = "Mousse.png";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        {
            new DownloadImageTask(this).execute("http://mjoy.ua/radio/radio-mousse/image/bg.jpg");
        }
        else
        {
