 ...
 */
public class KredensCafeFragment extends Fragment implements IRadioFragment {

    private ImageView bgView;
    private String imageNameString = "Kredens.png";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        {
            new DownloadImageTask(this).execute("http://mjoy.ua/radio/kredens-cafe-radio/image/bg.jpg");
        }
        else
        {
