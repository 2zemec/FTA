 ...
 */
public class EgoFragment extends Fragment implements IRadioFragment {

    private ImageView bgView;
    private String imageNameString = "Ego.png";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        {
            new DownloadImageTask(this).execute("http://mjoy.ua/radio/egoisty/image/bg.jpg");
        }
        else
        {
