 ...
 */
public class GreatestSongFragment extends Fragment implements IRadioFragment {

    private ImageView bgView;
    private String imageNameString = "GreatestSong.png";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        {
            new DownloadImageTask(this).execute("http://mjoy.ua/radio/radio-great/video/bg.jpg");
        }
        else
        {
