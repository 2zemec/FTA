 ...
 */
public class RadioMFragment extends Fragment implements IRadioFragment {

    private ImageView bgView;
    private String imageNameString = "RadioM.png";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        {
            new DownloadImageTask(this).execute("http://mjoy.ua/radio/radio-m/images/bg.jpg");
        }
        else
        {
